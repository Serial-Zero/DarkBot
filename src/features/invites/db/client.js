...
function logMissingConfiguration() {
  ...
  console.warn(
    '[Invites] Database configuration missing. ' +
      'Set DB_HOST, DB_USER, DB_NAME, and DB_PASSWORD in your environment to enable invite tracking.',
  );
}

export function getInvitePool() {
  if (pool) {
    return pool;
  }
